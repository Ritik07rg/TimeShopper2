...
import com.example.timeshopper.Seller.SellerProductCategoryActivity;
            ...
            productsRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task)
                {
                    if (task.isSuccessful())
                    {
                        ...
                        Intent intent = new Intent(AdminMaintainProductsActivity.this, AdminAllProductActivity.class);
    ...
    private void deleteThisProduct()
    {
        productsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task)
            {
                if (task.isSuccessful())
                {
                    Toast.makeText(AdminMaintainProductsActivity.this, "Products deleted Successfully!", Toast.LENGTH_SHORT).show();
